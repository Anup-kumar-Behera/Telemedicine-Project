...
const SignUpDoctor = require('./controllers/SignUpDoctor')
const VerificationDoctor = require('./controllers/VerificationDoctor')
...
sequelize
  ...
  User.hasOne(VerificationToken1)
  ...
  Doctor.hasOne(VerificationToken2)
  ...
  VerificationToken1.belongsTo(User,{as: 'user', foreignKey : 'patientId'});
  VerificationToken2.belongsTo(Doctor,{as: 'doctor',foreignKey : 'docId'})
  ...
  VerificationToken1.sync()
  .then(() => console.log('Oh yeah! Verification1 table created successfully'))
  .catch(err => console.log('BTW, did you enter wrong database credentials for verification 1'))
  VerificationToken2.sync()
  .then(() => console.log('Oh yeah! Verification2 table created successfully'))
  .catch(err => console.log('BTW, did you enter wrong database credentials for verification2', err))
...
app.get('/userEmail/verification', VerificationController);

app.post('/patient/register', SignUpController)

app.get('/doctorEmail/verification', VerificationDoctor)
app.post('/doctor/register', SignUpDoctor)
